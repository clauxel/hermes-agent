export function HermesAgentLogo() {
  return (
    <svg viewBox="0 0 96 96" fill="none" aria-hidden="true">
      <defs>
        {/* Vibrant Gradient Background */}
        <linearGradient id="ha-bg" x1="0" y1="0" x2="96" y2="96" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#4F46E5" />   {/* Indigo 600 */}
          <stop offset="50%" stopColor="#9333EA" />  {/* Purple 600 */}
          <stop offset="100%" stopColor="#E11D48" /> {/* Rose 600 */}
        </linearGradient>

        <linearGradient id="ha-shape-grad" x1="28" y1="16" x2="68" y2="80" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#FFFFFF" />
          <stop offset="100%" stopColor="#F8FAFC" stopOpacity="0.85" />
        </linearGradient>

        <linearGradient id="ha-center-grad" x1="28" y1="48" x2="68" y2="48" gradientUnits="userSpaceOnUse">
        ...
        <filter id="ha-drop" x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow dx="0" dy="4" stdDeviation="4" floodColor="#000000" floodOpacity="0.3" />
        </filter>
      </defs>

      {/* Vibrant Background container */}
      <rect width="96" height="96" rx="22" fill="url(#ha-bg)" />
      
      {/* Light inner border for premium feel */}
      <rect x="1.5" y="1.5" width="93" height="93" rx="20.5" stroke="#FFFFFF" strokeOpacity="0.15" strokeWidth="1.5" />

      {/* The Neural Constellation - White/Glass Morphism */}
      <g filter="url(#ha-drop)">
        {/* Core solid shapes */}
        <path d="M 26 18 Q 26 48 38 48 Q 26 48 26 78 Q 26 48 14 48 Q 26 48 26 18 Z" fill="url(#ha-shape-grad)" />
        <path d="M 70 18 Q 70 48 82 48 Q 70 48 70 78 Q 70 48 58 48 Q 70 48 70 18 Z" fill="url(#ha-shape-grad)" />
        <path d="M 28 48 Q 48 48 48 34 Q 48 48 68 48 Q 48 48 48 62 Q 48 48 28 48 Z" fill="url(#ha-center-grad)" />
      </g>

      {/* Extreme Core Highlight */}
      <path d="M 40 48 Q 48 48 48 44 Q 48 48 56 48 Q 48 48 48 52 Q 48 48 40 48 Z" fill="#FFFFFF" />
      <circle cx="48" cy="48" r="2.5" fill="#FFFFFF" filter="url(#ha-glow)" />
    </svg>
  )
}
