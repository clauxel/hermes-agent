...
export type ClawInstanceRecord = {
  id: string
  orderId: string
  deploymentId: string
  sequenceNumber: number
...
export type OrderRecord = {
  ...
  instance: ClawInstanceRecord | null
}

export type ConsoleData = {
  orders: OrderRecord[]
  claws: ClawInstanceRecord[]
}
...
export type HermesVersionOption = {
  id: string
  name: string
}

export type HermesVersionsResponse = {
  versions: HermesVersionOption[]
