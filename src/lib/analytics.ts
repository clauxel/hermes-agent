...
const visitorStorageKey = 'hermes-analytics-visitor-id'
const sessionStorageKey = 'hermes-analytics-session'
const pendingEventsStorageKey = 'hermes-analytics-pending-events'
