---
title: "Introduction"
source: https://hermesagent.studio/guide/introduction
mirrored_at: 2026-04-12T01:11:32Z
---
# Introduction

Hermes Agent is an open-source, self-hosted AI agent framework maintained by [HermesAgent Studio](https://hermesagent.studio/). It is released under the **MIT License**, and this documentation is based on **v0.2.0**. The source code lives on [GitHub](https://github.com/clauxel/Hermes-Agent).
...
- **Repository**: [clauxel/Hermes-Agent](https://github.com/clauxel/Hermes-Agent)
