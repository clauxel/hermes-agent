...
source: https://hermesagent.studio/guide/security
...
You can define approved users in `.env` or `config.yaml`:
...
If preconfiguring user IDs is inconvenient, enable direct-message pairing:
...
1. An admin runs `hermes gateway pair` to generate an 8-character pairing code such as `A3X9-KP7Q`
2. The new user sends the code to the bot
3. Hermes validates the code and adds the user to the allowlist
4. The code expires automatically and can be used only once
...
# Example output:
# Pairing code: A3X9-KP7Q
# Expires in: 10 minutes
# Send this code to the user you want to authorize
```
...
- [GitHub Security Advisories](https://github.com/clauxel/Hermes-Agent/security)
