---
title: "Tool System"
source: https://hermesagent.studio/features/tools
mirrored_at: 2026-04-12T01:11:32Z
---
# Tool System

Hermes Agent includes a broad built-in tool ecosystem: **47 registered tools** across **37 toolsets** covering web access, terminal execution, browser automation, media handling, memory, and agent orchestration.
...
| `file` | `read_file`, `patch` | File access and editing |
