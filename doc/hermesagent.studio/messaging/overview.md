...
source: https://hermesagent.studio/messaging/overview
...
2. An admin approves it with `hermes pairing approve <request-id>`
3. The user is added to the authorized list

To revoke access:

```bash
hermes pairing revoke <user-id>
```
